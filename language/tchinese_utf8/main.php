...
define('_MD_JILLNOTICE_TYPE', '類型');
define('_MD_JILLNOTICE_CATE', '分類');
define('_MD_JILLNOTICE_TITLE', '標題');
define('_MD_JILLNOTICE_CONTENT', '內文');
...
define('_MD_JILLNOTICE_STATUS2', '已停用');
define('_MD_JILLNOTICE_STATUS0', '申請中');
